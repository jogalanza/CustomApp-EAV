      ...
      extendWebpack(cfg) {
        ...
        cfg.plugins.push(
          new ModuleFederationPlugin({
            ...
            filename: 'remoteEntry.js', // Entry file for remotes to access
            remotes: {
              // Define remote apps (example: a remote app running on port 8081)
              remoteApp:
                'remoteApp@https://localhost:7053/Plugins/Plugin.Default/component/dist/remoteEntry.js',
            },
            exposes: {}, // Nothing exposed from host (yet)
            shared: {
              // Share dependencies between host and remotes
              vue: {
                singleton: true, // Ensure only one instance of Vue is used
        ...
        // Disable splitChunks to avoid conflicts with Module Federation
