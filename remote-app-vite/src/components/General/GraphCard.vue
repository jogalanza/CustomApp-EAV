  ...
  <QCard flat class="graph-card q-pb-md">
    ...
    <div v-if="CalcShowComment" class="side-comment col-12 q-pa-sm scroll q-mx-md">
      ...
      <QCardSection v-if="options.remarkType && options.remarkType.indexOf(1) > -1" class="q-pa-none q-pb-sm">
        <QInput v-model="remarks.comment" :disable="commentLoading > 0" :loading="commentLoading" dense label="Comment" class="graph-comment" type="textarea" autogrow :maxlength="5000" borderless
          :readonly="CalcReadOnly" />
      </QCardSection>
      <QCardSection v-if="options.remarkType && options.remarkType.indexOf(2) > -1" class="q-pa-none q-pb-sm">
        <QInput v-model="remarks.highlights" :disable="commentLoading" :loading="commentLoading" dense label="Highlights" class="graph-comment" type="textarea" autogrow :maxlength="5000" borderless
          :readonly="CalcReadOnly" />
      </QCardSection>
      <QCardSection v-if="options.remarkType && options.remarkType.indexOf(3) > -1" class="q-pa-none q-pb-sm">
        <QInput v-model="remarks.lowlights" :disable="commentLoading" :loading="commentLoading" dense label="Lowlights" class="graph-comment" type="textarea" autogrow :maxlength="5000" borderless
          :readonly="CalcReadOnly" />
      </QCardSection>
    </div>
        ...
        <QCardSection v-if="showChart" class="row" style="height: calc(100% - 50px)">
          ...
          <div v-if="CalcShowComment" :class="`side-comment ${(CalcShowComment ? 'col-12 col-sm-4' : 'col-12')} q-pa-md scroll`">
            ...
            <QCardSection v-if="options.remarkType && options.remarkType.indexOf(1) > -1" class="q-pa-none q-pb-md">
              <QInput v-model="remarks.comment" :disable="commentLoading" :loading="commentLoading" dense label="Comment" class="graph-comment full-window" type="textarea" autogrow :maxlength="5000"
            ...
            <QCardSection v-if="options.remarkType && options.remarkType.indexOf(2) > -1" class="q-pa-none q-pb-md">
              <QInput v-model="remarks.highlights" :disable="commentLoading" :loading="commentLoading" dense label="Highlights" class="graph-comment full-window lohigh" type="textarea" autogrow
            ...
            <QCardSection v-if="options.remarkType && options.remarkType.indexOf(3) > -1" class="q-pa-none q-pb-md">
              <QInput v-model="remarks.lowlights" :disable="commentLoading" :loading="commentLoading" dense label="Lowlights" class="graph-comment full-window lohigh" type="textarea" autogrow
                :maxlength="5000" borderless :readonly="CalcReadOnly" />
            </QCardSection>
          </div>
        </QCardSection>
