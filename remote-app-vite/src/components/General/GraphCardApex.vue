  ...
  <QCard flat class="graph-card q-pb-md">
    ...
    <QToolbar class="chart-toolbar q-py-sm q-px-md">
      <slot name="chart-toolbar">
        ...
        <QBtn v-if="dirty" round flat icon="o_save" dense @click="SaveChanges" size="sm"><QTooltip>Save Changes</QTooltip></QBtn>
        <QBtn round flat icon="o_refresh" dense @click="RefreshChart" size="sm"><QTooltip>Refresh</QTooltip></QBtn>
        <QBtn round flat icon="o_fullscreen" dense @click="dialog = !dialog" size="sm"><QTooltip>Toggle Fullscreen View</QTooltip></QBtn>
      </slot>
    </QToolbar>
    ...
    <QCardSection v-if="options.remarkType && options.remarkType.indexOf(1) > -1" class="q-pa-sm q-px-md">
      <QInput v-model="remarks.comment" :disable="commentLoading > 0" :loading="commentLoading > 0" dense label="Comment" class="graph-comment" type="textarea" autogrow :maxlength="5000"
        borderless />
    </QCardSection>
    <QCardSection v-if="options.remarkType && options.remarkType.indexOf(2) > -1" class="q-pa-sm q-px-md">
      <QInput v-model="remarks.highlights" :disable="commentLoading > 0" :loading="commentLoading > 0" dense label="Highlights" class="graph-comment" type="textarea" autogrow :maxlength="5000"
        borderless />
    </QCardSection>
    <QCardSection v-if="options.remarkType && options.remarkType.indexOf(3) > -1" class="q-pa-sm q-px-md">
      <QInput v-model="remarks.lowlights" :disable="commentLoading > 0" :loading="commentLoading > 0" dense label="Lowlights" class="graph-comment" type="textarea" autogrow :maxlength="5000"
        borderless />
    </QCardSection>
    ...
    <!-- <q-dialog v-model="dialog" maximized>
      <QCard class="graph-card-fs">
        ...
        <QCardSection class="row" style="height: calc(100vh - 50px)">
          ...
          <div class="side-comment col-12 col-sm-4 q-pa-md scroll">
            <QCardSection v-if="options.remarkType && options.remarkType.indexOf(1) > -1" class="q-pa-none">
              <QInput v-model="remarks.comment" :disable="commentLoading > 0" :loading="commentLoading > 0" dense label="Comment" class="graph-comment full-window" type="textarea" autogrow
                :maxlength="5000" borderless />
            </QCardSection>
            <QCardSection v-if="options.remarkType && options.remarkType.indexOf(2) > -1" class="q-pa-none">
              <QInput v-model="remarks.highlights" :disable="commentLoading > 0" :loading="commentLoading > 0" dense label="Highlights" class="graph-comment full-window lohigh" type="textarea"
                autogrow :maxlength="5000" borderless />
            </QCardSection>
            <QCardSection v-if="options.remarkType && options.remarkType.indexOf(3) > -1" class="q-pa-none">
              <QInput v-model="remarks.lowlights" :disable="commentLoading > 0" :loading="commentLoading > 0" dense label="Lowlights" class="graph-comment full-window lohigh" type="textarea" autogrow
                :maxlength="5000" borderless />
            </QCardSection>
          </div>
        </QCardSection>
