  ...
  <MultiView title="Key Focus Areas" class="comment-card" @refresh="GetMaster" @save="Save" :dirty="true" :config="config" :with-history="false" style="min-height: 0px">
    ...
    <QList class="" style="height: calc(100% - 60px)">
      ...
      <QItem style="padding: 8px; height: calc(100%);">
        <QInput ref="editor" class="key-focus-editor" filled v-model="item.comment" :readonly="readonly" style="min-height: 180px; width: 100%; height: 100%" type="textarea">
    ...
    <q-dialog v-model="dialog" persistent>
      <QCard class="comment-card-fs">
        ...
        <QList class="" style="height: calc(100% - 50px)">
          ...
          <QItem style="padding: 8px; height: calc(100%);">
            <QInput ref="editor2" class="key-focus-editor" filled v-model="item.comment" :readonly="readonly" style="min-height: 180px; width: 100%; height: 100%" type="textarea">
            </QInput>
          </QItem>
        </QList>
      </QCard>
