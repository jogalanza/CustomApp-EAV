<template>
    <QList class="bowler-comment">
        <QItem class="q-pa-none">
            <QItemSection>
                <QInput ref="editor" class="key-focus-editor" borderless v-model="_item.comment" :style="`width: 100%; height: ${(extended ? '128px' : '52px')}`" type="textarea" autofocus
                    :readonly="readonly">
                </QInput>
            </QItemSection>
        ...
        <!-- <QItem class="q-pa-none">
            <QItemSection>
                <QItemLabel>
                    <QInput ref="editor" class="key-focus-editor" borderless v-model="_item.comment" :style="`min-height: 52px; width: 100%; height: ${(extended ? '128px' : '52px')}`" type="textarea"
