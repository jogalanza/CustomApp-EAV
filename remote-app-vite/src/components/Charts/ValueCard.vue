<template>
  <QCard style="width: 100%">
    <QCardSection :class="titleClass" style="text-overflow:ellipsis;white-space:nowrap;overflow:hidden">{{ title }}</QCardSection>
    <QCardSection class="q-py-none text-h3 text-bold text-center justify-center column" style="min-height: 120px">
