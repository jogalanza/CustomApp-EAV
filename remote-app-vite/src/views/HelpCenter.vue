<template>
  ...
  >
    <QCard class="absolute" flat style="height: 100%; width: 100%">
      <QCardSection
      ...
      >
        ...
        >
          <QToolbarTitle :class="`app-title in-board clip`">
        ...
        >
                ...
                <div class="row justify-center">
                  <div class="col-11">
                    <div v-if="cms.Trainings.length > 0" class="row">
                      ...
                      >
                        <QCard class="info-card" @click="ViewTraining(m)">
                          <QImg
                          ...
                          >
                            <template v-slot:error>
                              <QImg :src="require('../assets/people.jpg')" />
                            </template>
                          </QImg>
                          <QImg v-else :src="require('../assets/people.jpg')" />
                          <span
                            ...
                            >Featured</span
                          >
                          <QCardSection class="title q-py-sm">{{
                            m.attributes.title
                          }}</QCardSection>
                          <QCardSection class="description q-pt-none"
                            ><p>{{ m.attributes.details }}</p></QCardSection
                          >
                        </QCard>
                      </div>
                    </div>
              ...
              <q-tab-panel name="faqs">
                <div class="row justify-center q-pt-lg">
                  <div class="col-11 col-sm-8">
                    <QList v-if="cms.FAQS.length > 0">
                      <QExpansionItem popup
          ...
          >
            ...
            <QCard flat style="width: 100%; height: calc(100% - 50px)">
              <!-- <QCardSection>{{ activeTraining.attributes.details }}</QCardSection> -->
              <QCardSection
                  ...
                  <div class="col-11">
                    <div class="row">
                      ...
                      >
                        ...
                        >
                          <QImg :src="require('../assets/folder.jpg')" />
                          <QCardSection class="title q-py-sm">{{
                            m.attributes.name
                          }}</QCardSection>
                        </QCard>
