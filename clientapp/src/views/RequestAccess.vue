<template>
  <q-card class="login-page flex flex-center" :style="`background: url('${require('@/assets/etc2.png')}'); background-position-y: -72%`">
    <q-card-section :class="{ container: true, maximized: mobile }">
      <q-card :class="{ 'request-card text-white': true, maximized: mobile }">
        <q-card-section class="upper-section text-center q-pt-lg q-pb-none col-6">
          <q-img :src="require('@/assets/excelitas_logo.png')" width="180px" style="margin-top: 32px; margin-bottom: 16px;" />
        ...
        <q-card-section class="lower-section col-6 row">
          ...
          <div class="col-6 q-mb-md q-px-sm">
            <q-btn class="full-width" no-caps :label="loading
          ...
          <div class="col-6 q-mb-md q-px-sm">
            <q-btn class="full-width" no-caps label="Try again" color="green" size="md" @click="Reload" />
          </div>
        </q-card-section>

        <!-- <q-separator dark class="q-mx-md" />

        <q-card-section class="text-center q-pa-lg col-12" style="font-size: 0.8em">
