<template>
  ...
  >
    <q-card-section :class="{ maximized: mobile }">
      <q-card :class="{ 'login-card text-white': true, maximized: mobile }">
        <q-card-section class="text-center q-pt-lg q-pb-none">
          <q-img src="images/excelitas_logo.png" width="180px" />
        ...
        <!-- FORGOT PASSWORD -->
        <q-card-section v-if="mode === 2 && showUI" class="row">
        ...
        <!-- SIGN UP -->
        <q-card-section v-else-if="mode === 3 && showUI" class="row">
          <q-list class="full-width" style="max-height: 440px;overflow-y:auto">
            <q-item-label class="text-h5 text-center q-pb-md">Sign Up</q-item-label>
        ...
        <q-card-section v-else-if="showUI">
          <q-carousel
            v-model="panel"
        ...
        <q-card-section class="text-center q-pa-lg" style="font-size: 0.8em">
          <div>PDCS 2022</div>
