<template>
  <q-card class="graph-card" style="width: 100%; height: 350px">
    <q-toolbar v-if="!chartOnly">
      <q-toolbar-title :class="`graph-toolbar ${titleClass}`">{{ title }}</q-toolbar-title>
      <q-space />
      <q-spinner v-if="loading" />
    </q-toolbar>
    <q-card-section class="q-pa-none q-pb-sm" :style="`height: calc(100% - ${(chartOnly ? '0' : '50')}px)`">
