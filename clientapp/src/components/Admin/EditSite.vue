  ...
  <EditDialog class="batch-clocking" :dialog="dialog" @ondialog="dialog = $event" action-style="height: 70px" content-style="height: calc(100% - 120px);">
    ...
    <q-list class="full-width" style="height: 100%; overflow: auto; padding: 4px">
      ...
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.SiteName" label="Name" @focus="SelectInput" autofocus />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.City" label="City" @focus="SelectInput" />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.State" label="State" @focus="SelectInput" />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.Country" label="Country" @focus="SelectInput" />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.Region" label="Region" @focus="SelectInput" />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>Include in Consolidated Sum
          </q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-checkbox filled v-model="item.InConsoSum" :true-value="true" :false-value="false" />
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
        ...
        <q-item-section side>
          <q-checkbox filled v-model="item.Active" :true-value="true" :false-value="false" />
        </q-item-section>
      </q-item>
    </q-list>
