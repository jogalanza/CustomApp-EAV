  ...
  <EditDialog class="batch-clocking" :dialog="dialog" @ondialog="dialog = $event" action-style="height: 70px" content-style="height: calc(100% - 120px);">
    ...
    <q-list class="full-width" style="height: 100%; overflow: auto; padding: 4px">
      ...
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.PERIOD_MONTH" label="Period Month" type="number" input-class="text-right" @focus="SelectInput" autofocus />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-input filled v-model="item.PERIOD_YEAR" label="Period Year" type="number" input-class="text-right" @focus="SelectInput" />
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-item class="q-px-none">
        <q-item-section>
          <q-item-label>
            <q-date v-model="item.START_DATE" mask="DD-MMM-YYYY" style="min-width: 0px; width: 100%;" today-btn title="Start Date" />
          </q-item-label>
        </q-item-section>
        <q-item-section>
          <q-item-label>
            <q-date v-model="item.END_DATE" mask="DD-MMM-YYYY" style="min-width: 0px; width: 100%;" today-btn title="End Date" />
          </q-item-label>
        </q-item-section>
      </q-item>
    </q-list>
