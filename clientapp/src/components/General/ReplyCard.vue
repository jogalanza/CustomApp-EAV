<template>
  <q-item :key="key" class="q-px-none">
    <q-item-section avatar top>
      <q-avatar size="32px" style="background: transparent; margin-top: 4px">
        <q-img
    ...
    <q-item-section style="justify-content: flex-start; padding-top: 4px">
      <q-item-label class="q-card q-pa-sm" style="border-radius: 8px">
        <div class="q-mb-sm">
            ...
            <q-menu auto-close>
              <q-list dense>
                <q-item
                  ...
                  >Edit</q-item
                >
                <q-item dense clickable @click="DeleteComment(item.ID)"
                  >Delete</q-item
                >
              </q-list>
            </q-menu>
