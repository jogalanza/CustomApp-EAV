<template>
  <q-toolbar v-if="toolbar" style="flex-wrap: wrap">
    <q-tabs
      inline-label
      outside-arrows
      mobile-arrows
  ...
  <q-card v-else flat style="height: 100%">
    <q-toolbar class="q-py-sm">
      ...
      <q-toolbar-title
        ...
        >{{ GetLocaleString("FILTER", "Filter") }}</q-toolbar-title
      >
    </q-toolbar>
    <q-card-section class="q-pa-sm q-px-md" style="height: calc(100% - 58px)">
      <div class="q-mb-sm">
